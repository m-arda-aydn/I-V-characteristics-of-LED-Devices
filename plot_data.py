...
text1 = open(str(FILE_PATH/'AI_Dataset1_edited.txt')) # I created a new dataset txt file by deleting the last four experimental values of the original file (AI_Dataset1_edited.txt)
